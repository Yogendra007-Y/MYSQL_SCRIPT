...
#UC3 - Insert Contacts
insert into employee_payroll (name, salary, start) VALUES ('Yogi', 2000000.00, '2018-03-12'),('Terisa', 1500000.00, '2019-06-01'), ('Mike', 1800000.00, '2014-01-15');
...
update employee_payroll set gender = 'M' where name in('Yogi','Mike');
